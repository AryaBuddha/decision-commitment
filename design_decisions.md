...
| logistic regularization C | sklearn default 1.0 | UNLISTED until Block B4 found it: convenience by omission | Shrinks extreme log-odds in the ratio fit, driving the non-equivalence of correctly specified estimators at extreme bounded tilts (wp1clip verdict: flat across clip widths, so the old clip-binding story was wrong) | Candidate registered follow-up: C in {1, 10, 100, unregularized} at the wp1clip cells; prediction from a design audit first |
